...
export const IndiaMap = ({stateData}) => {
    India.locations[0]['path'] = ''
    console.log(India.locations);
    ...
    const handleLocationMouseOver = (event) => {
        ...
        console.log(clientX, (clientX > (window.screen.width / 2))  ? clientX - 75 : clientX + 75);
        
        tooltipTimeout = setTimeout(() => {
            setTooltipStyle({
            display: 'block',
            top: clientY + 10,
            left: (clientX > (window.screen.width / 2))  ? clientX - 250 : clientX
        });
